...
namespace MyTeam
{
    public partial class App : Application
    {
        ...
        private void FillTeamInfoDataTable(DataTable table)
        {
            ...
            //osfp
            table.Rows.Add("osfp", "ΟΣΦΠ", "Contra", "Atom", "http://www.contra.gr/soccer/olympiacos/?widget=rssfeed&view=feed");
            ...
            table.Rows.Add("osfp", "ΟΣΦΠ", "NovaSports", "RSS", "http://www.novasports.gr/sys/novasports/RssFeed/GetFeed?type=2&id=16641&languageID=1");
            table.Rows.Add("osfp", "ΟΣΦΠ", "OnSports", "RSS", "http://www.onsports.gr/omades/olympiakos?format=feed&type=rss");
            table.Rows.Add("osfp", "ΟΣΦΠ", "Sport24", "Atom", "http://www.sport24.gr/football/omades/olympiakos/?widget=rssfeed&view=feed&contentId=174866");
            //pao
